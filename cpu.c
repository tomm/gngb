...
#define CP_A_R(v) {UINT16 r=A-(v); ((r&0x0100)?SET_FLAG(FLAG_C):UNSET_FLAG(FLAG_NC)); ((r&0xff)?UNSET_FLAG(FLAG_NZ):SET_FLAG(FLAG_Z)); ((((A&0x0f)-((v)&0x0f))&0x10)?SET_FLAG(FLAG_H):UNSET_FLAG(FLAG_NH)); SET_FLAG(FLAG_N); } 
